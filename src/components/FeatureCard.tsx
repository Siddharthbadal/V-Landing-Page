...
export default function FeatureCard() {
  return (
    <div>
            <Link href={'/'}>
                <article className="bg-white rounded-xl border border-gray-200 p-6 hover:border-gray-800 h-full">
                    <header className="flex flex-col gap-y-3">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-12 text-blue-800">
